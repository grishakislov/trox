...
public class GameSettings {
    ...
    public static const VEIN_STEP_SECONDS:uint = 3;

    public static const BLISTER_ENABLE_DELAY_MILLIS:uint = 3000;
    public static const MAX_VALVE_ILL_DELAY_MILLIS:uint = 1000;
    public static const MAX_ERYTH_MOVING_REVERSE_MILLIS:uint = 2000;

    public static const MILLIS_AFTER_BUTTON_CLICK:uint = 1000;
    public static const GAME_OVER_DELAY_MILLIS:uint = 6000;
    public static const CURE_DELAY:uint = 2000;
